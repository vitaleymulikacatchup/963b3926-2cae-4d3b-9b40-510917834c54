...
export const metadata: Metadata = {
  title: "Smakoluk - Fine Dining Restaurant",
  description: "Award-winning restaurant offering exceptional culinary experiences with locally-sourced ingredients and innovative dishes.",
  keywords: "fine dining, restaurant, cuisine, reservations, gourmet",
  openGraph: {
    title: "Smakoluk - Fine Dining Restaurant",
    description: "Experience culinary excellence at Smakoluk. Award-winning chefs, premium ingredients, unforgettable dining.",
    siteName: "Smakoluk",
    type: "website"
  },
  robots: {
